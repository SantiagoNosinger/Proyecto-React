...
export default class ListaAlquileres extends React.Component{
    ...
    render(){
        return(
            ...
            <div className="container shadow my-5 ">
                <div className="row gradientesdivs rounded shadow-drop-center">
                    <div className={"col-12 py-4 shadow d-flex align-items-center rounded border border-" + this.props.boton}>
                        ...
                        <div className="gradienteLetras rounded shadow">
                            <h2 className={"text-center " + this.props.color}>{this.props.titulo}</h2>
